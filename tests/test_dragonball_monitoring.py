...
def test_dragonball_source_coverage_includes_general_retailers_only() -> None:
    ...
    assert all(
        "dragon_ball_fusion_world" in by_id[source_id].supported_games
    ...
    assert all(
        "dragon_ball_fusion_world" not in by_id[source_id].supported_games
...
def test_dragonball_official_store_waits_for_real_application_start() -> None:
    ...
    article_url = (
        ...
        "official_shop/dbs-cardgame/news/important/20260714.html"
    )
...
def test_dragonball_official_store_parses_actual_application_period_label() -> None:
    ...
    url = (
        "https://bandainamco-am.co.jp/"
        "official_shop/dbs-cardgame/news/important/20260728.html"
    )
