...
class SourceConfig:
    ...
    # Parser-specific data lives in configuration instead of Python source.
    # This keeps the parser generic and allows the runtime configuration to
    # provide location-specific retailer names, account handles, and URLs.
